...
\cftsetindents{subsubsection}{3.5em}{4em}
\setcounter{tocdepth}{3}
\setcounter{secnumdepth}{5}


% ABBILDUNGEN, TABELLEN UND CODE_AUSZUGS SETUP
\renewcommand{\listfigurename}{Abbildungsverzeichnis}
\renewcommand{\listtablename}{Tabellenverzeichnis}
\renewcommand{\lstlistlistingname}{Code-Auszugsverzeichnis}
...
\addtocontents{lol}{\linespread{2}\selectfont}

\makeatletter
\renewcommand{\cftfigpresnum}{Abb. }
\renewcommand{\cfttabpresnum}{Tab. }
\def\l@lstlisting#1#2{\@dottedtocline{1}{0cm}{1cm}{Code #1}{#2}}
...
\newtotcounter{listingsCount}
\let\oldTabTOC=\table
\let\oldFigTOC=\figure
\let\oldListTOC=\lstinputlisting
\renewcommand{\figure}{\stepcounter{figCount}\oldFigTOC}
\renewcommand{\table}{\stepcounter{tabCount}\oldTabTOC}
\renewcommand{\lstinputlisting}{\stepcounter{listingsCount}\oldListTOC}

\renewcommand{\arraystretch}{1.5} % Zeilenhöhe von Tabellen
...
\RenewAcroTemplate[list]{description}{%
    \acronymsmapT{%
        \AcroAddRow{%
            ...
            {\acrotranslate{page}\nobreakspace}%
            {\acrotranslate{pages}\nobreakspace}%
            % this was here without parskip enabled: \vspace{10pt}
            \tabularnewline
        }%
    }%
    \acroheading
